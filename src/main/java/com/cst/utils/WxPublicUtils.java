...
public class WxPublicUtils {
    ...
    public static boolean verifyUrl(String msgSignature, String timeStamp, String nonce)
        ...
        String signature = SHA1.getSHA1(ConstantsValue.WX_TOKEN, timeStamp, nonce);
...
//        try {
//            WXBizMsgCrypt pc =
//                    new WXBizMsgCrypt(WxConstants.TOKEN, WxConstants.ENCODING_AES_KEY, WxConstants.APP_ID);
...
//            WXBizMsgCrypt pc =
//                    new WXBizMsgCrypt(WxConstants.TOKEN, WxConstants.ENCODING_AES_KEY, WxConstants.APP_ID);
//            return pc.encryptMsg(replyMsg, String.valueOf(System.currentTimeMillis()), pc.getRandomStr());
//        } catch (AesException e) {
//            log.error(e.getMessage());
//        }
//        return null;
